...
def main() -> None:
    ...
    rrf_search_parser.add_argument("--rerank-method", type=str,choices=["individual", "batch"], help="Re-ranking search results" )
    ...
    match args.command:
        ...
        case "rrf-search":
            rrf_search_command(query=args.query, k=args.k, limit=args.limit, enhance=args.enhance, re_rank=args.rerank_method)
        case _:
            parser.print_help()
