...
from commands import idf_command, tfidf_command
...
def main() -> None:
    ...
    tfidf_parser.add_argument("search_term", type=str, help="Search term whose TF-IDF score is to be calculated")
    ...
    match args.command:
        ...
        case "idf":
            print(f"Finding the IDF of {args.term}...")
